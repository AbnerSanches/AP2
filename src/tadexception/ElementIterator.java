...
E toReturn = cursor.element(); //Pega o element da posição do cursor, cursor = (cursor == list.last()) ? null : list.next(cursor); // se cursor for ultimo, retorna null, senao pega o proximo
