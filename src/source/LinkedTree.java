...
import tadexception.DNode;
import tadexception.InvalidPositionException;
import position.Position;
import tadexception.NodePositionList;
...
// }
	...
	public void postOrder(Position<E> v, PositionList<Position<E>> pos) {
		pos.addLast(v);
		for (Position<E> w : children(v)) {
